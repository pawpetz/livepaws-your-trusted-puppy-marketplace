...
export const streams: Stream[] = [
  ...
  {
    id: "maine-coon-nursery",
    title: "Maine Coon nursery — kitten cuddles",
    breeder: "Northwind Cattery",
    breed: "Maine Coon",
    species: "cat",
    registry: "TICA Registered",
    viewers: 274,
    isLive: true,
    thumbnail: img("1592194996308-7b43878e84a6"),
    verified: true,
  },
  {
    id: "ragdoll-playtime",
    title: "Ragdoll kittens learning to pounce",
    breeder: "Blue Bell Ragdolls",
    breed: "Ragdoll",
    species: "cat",
    registry: "CFA Certified",
    viewers: 156,
    isLive: true,
    thumbnail: img("1519052537078-e6302a4968d4"),
    verified: true,
  },
  {
    id: "aussie-play",
  ...
  {
    id: "sphynx-showcase",
    title: "Sphynx Pet Showcase — meet the naked crew",
    breeder: "Velvet Sphynx",
    breed: "Sphynx",
    species: "cat",
    registry: "TICA Registered",
    viewers: 0,
    isLive: false,
    scheduledFor: "Fri 8:00 PM",
    thumbnail: img("1606214174585-fe31582dc6ee"),
    verified: true,
  },
  {
    id: "bengal-sat",
    title: "Bengal kittens — wild spots weigh-in",
    breeder: "Riverstone Bengals",
    breed: "Bengal",
    species: "cat",
    registry: "TICA Registered",
    viewers: 0,
    ...
    thumbnail: img("1573865526739-10659fec78a5"),
    verified: true,
  },
  {
    id: "dachshund-sat",
